...
RESUME_MODEL='results/defocus_blur/level_3/round_1/checkpoints/model_49.pth'
RESUME_FINETUNE='checkpoints/prob_lr1e-3_wd.2_blk12_ep20.pth'
RESUME_FINETUNE='results/defocus_blur/level_3/round_1/checkpoints/model_49.pth'
